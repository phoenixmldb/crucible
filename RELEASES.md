...
### NuGet
- `crucible` (CLI tool) — first stable release at `1.1.x` (skipping `1.0.0` because the prior package id `crucible.cli 1.0.0` was the de facto baseline pre-rename)
- `crucible.extensions` `1.0.0` → `1.1.x`
